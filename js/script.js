...
const scrollDownBtn = document.getElementById("scroll_id");
if (scrollDownBtn) {
...
function appAge() {
  ...
  let data = setInterval(() => {
    ...
    if (empty_field != "" && full_month != "" && year != "") {
      ...
      userData.set("yearOfBirth", selectS);
...
async function formValidation() {
  ...
  orderForm.addEventListener("submit", (e) => {
    e.preventDefault();
    e.target.querySelector(".submit-roulette").disabled = true;

    userData.set("name", orderForm.name.value);
    userData.set("phone", orderForm.phone.value);
